...
int DefaultCommandTimeout = (int)FromDays(1).TotalSeconds;
...
try
{
    ...
    PublishDacpac(publishFileFullPath, dacpacFileFullPath, DefaultCommandTimeout);
...
static void SetupRegistryQueryExecutionTimeout()
{
